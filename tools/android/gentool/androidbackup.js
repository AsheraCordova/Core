...
if (process.argv[2] == 'restore') {
	...
	cpx.copy("tsc" + "/**", projectBasePath + "android_backup/tsc", {ignore : ["node_modules", "*.lock", "android", "app", "R", "navigation", "ChildApp.ts", "app.ts", "ErrorDetailFragment.ts", "widget", "ErrorFragment.ts", "FragmentFactory.ts", "app.ts","package-lock.json", "webpack.config.js"]});
