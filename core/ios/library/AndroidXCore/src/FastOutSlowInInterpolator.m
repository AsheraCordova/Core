...
/*!
 @brief Lookup table values sampled with x at regular intervals between 0 and 1 for a total of
  201 points.
 */
inline IOSFloatArray *ADXFastOutSlowInInterpolator_get_VALUES(void);
static IOSFloatArray *ADXFastOutSlowInInterpolator_VALUES;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ADXFastOutSlowInInterpolator, VALUES, IOSFloatArray *)

J2OBJC_INITIALIZED_DEFN(ADXFastOutSlowInInterpolator)

@implementation ADXFastOutSlowInInterpolator

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  ADXFastOutSlowInInterpolator_init(self);
  return self;
}
