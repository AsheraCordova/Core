...
- (instancetype)initWithASIWidget:(id<ASIWidget>)widget {
  ADToggleButton_initWithASIWidget_(self, widget);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ADToggleButton = { "ToggleButton", "r.android.widget", ptrTable, methods, NULL, 7, 0x401, 1, 0, -1, -1, -1, -1, -1 };
  return &_ADToggleButton;
}

@end

void ADToggleButton_initWithASIWidget_(ADToggleButton *self, id<ASIWidget> widget) {
