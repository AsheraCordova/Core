...
module.exports = (context) => {
	return new Promise((resolve, reject) => {
		console.log("start after install - core")
		...
		myProj.parse(function (err) {
			...
			var baseNames = ['drawable-ios', 'color', 'xml', 'menu', 'drawable', 'values', 'font', 'res_xml', 'anim', 'animator', 'navigation', 'raw'];
			var group = 'Resources';
			...
			console.log("done after install -- core")
			resolve();
		});
