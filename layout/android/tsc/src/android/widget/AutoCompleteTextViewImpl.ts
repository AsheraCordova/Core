...
export abstract class AutoCompleteTextViewImpl<T> extends ViewImpl<T>{
	...
	@Type(() => CommandAttr)
	@Expose({ name: "popupBackground" })
	popupBackground!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "onDismiss" })
	onDismiss!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "listSelection" })
	listSelection!:CommandAttr<number>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "entries" })
...
this.inputType.setTransformer('inputType');		return this.thisPointer;
	...
	public setPopupBackground(value : string) : T {
		this.resetIfRequired();
		if (this.popupBackground == null || this.popupBackground == undefined) {
			this.popupBackground = new CommandAttr<string>();
		}
		
		this.popupBackground.setSetter(true);
		this.popupBackground.setValue(value);
		this.orderSet++;
		this.popupBackground.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public setListSelection(value : number) : T {
		this.resetIfRequired();
		if (this.listSelection == null || this.listSelection == undefined) {
			this.listSelection = new CommandAttr<number>();
		}
		
		this.listSelection.setSetter(true);
		this.listSelection.setValue(value);
		this.orderSet++;
		this.listSelection.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
