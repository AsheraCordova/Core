...
return null;				}
	...
	private void removeaddTextChangedListenerIfNeeded(String action) {
		if (isInitialised()) {
			List<IListener> listeners = (List<IListener>)getFieldValueUsingReflection(appCompatAutoCompleteTextView, "mListeners");
			if (listeners != null) {
...
public java.util.Map<String, Object> getOnDismissEventObj( ) {
	...
	public void setId(String id){
		if (id != null && !id.equals("")){
			super.setId(id);
			appCompatAutoCompleteTextView.setId(IdGenerator.getId(id));
		}
	}
