...
return layoutParams.weight;			}
	...
	public class TableLayoutExt extends r.android.widget.TableLayout implements ILifeCycleDecorator, com.ashera.widget.IMaxDimension{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
	        ...
	        overlays = ViewImpl.drawOverlay(TableLayoutImpl.this, overlays);
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(TableLayoutImpl.this.getParent());
		...
		public void removeFromParent() {
        	TableLayoutImpl.this.getParent().remove(TableLayoutImpl.this);
		}
        @Override
		...
		public void setMyAttribute(String name, Object value) {
			...
			TableLayoutImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
