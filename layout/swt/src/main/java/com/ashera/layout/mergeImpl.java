...
public class mergeImpl extends BaseHasWidgets {
	//start - body
	private Object pane;
	public final static String LOCAL_NAME = "merge"; 
	public final static String GROUP_NAME = "merge";
	...
	public  mergeImpl(String localname) {
		super(GROUP_NAME, localname);
	}
	public  mergeImpl(String groupName, String localname) {
		super(groupName, localname);
	}

	@Override
	public IWidget newInstance() {
		return new mergeImpl(groupName, localName);
	}
	...
	public class mergeExt extends r.android.widget.FrameLayout implements ILifeCycleDecorator, com.ashera.widget.IMaxDimension{
		private MeasureEvent measureFinished = new MeasureEvent();
		private OnLayoutEvent onLayoutEvent = new OnLayoutEvent();
		private List<IWidget> overlays;
		public IWidget getWidget() {
			return mergeImpl.this;
		}
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
			...
			ViewImpl.setDrawableBounds(mergeImpl.this, l, t, r, b);
			if (!isOverlay()) {
			ViewImpl.nativeMakeFrame(asNativeWidget(), l, t, r, b);
			}
			replayBufferedEvents();
	        ViewImpl.redrawDrawables(mergeImpl.this);
	        overlays = ViewImpl.drawOverlay(mergeImpl.this, overlays);
        ...
        public void drawableStateChanged() {
        	...
        	if (!isWidgetDisposed()) {
        		ViewImpl.drawableStateChanged(mergeImpl.this);
        	}
        }
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(mergeImpl.this);
		...
		public void removeFromParent() {
        	mergeImpl.this.getParent().remove(mergeImpl.this);
		}
        @Override
		...
		public void setMyAttribute(String name, Object value) {
			...
			mergeImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(mergeImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(mergeImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(mergeImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(mergeImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(mergeImpl.this, 4, value);
    	}
        	public void state0() {
        		ViewImpl.state(mergeImpl.this, 0);
        	}
        	public void state1() {
        		ViewImpl.state(mergeImpl.this, 1);
        	}
        	public void state2() {
        		ViewImpl.state(mergeImpl.this, 2);
        	}
        	public void state3() {
        		ViewImpl.state(mergeImpl.this, 3);
        	}
        	public void state4() {
        		ViewImpl.state(mergeImpl.this, 4);
        	}
                        
        public void stateYes() {
        	ViewImpl.stateYes(mergeImpl.this);
        	
        }
        
        public void stateNo() {
        	ViewImpl.stateNo(mergeImpl.this);
        }
