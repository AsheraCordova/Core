...
public class StyledTextImpl extends BaseWidget implements IDrawable, IHasMultiNativeWidgets, ICustomMeasureHeight, ICustomMeasureWidth, com.ashera.validations.FormElement{
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("StyledText.tintMode", new TintMode());
	...
	public  StyledTextImpl(String localname) {
		super(GROUP_NAME, localname);
	}
	public  StyledTextImpl(String groupName, String localname) {
	...
	public class StyledTextExt extends r.android.widget.EditText implements ILifeCycleDecorator{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
	        ...
	        overlays = ViewImpl.drawOverlay(StyledTextImpl.this, overlays);
		...
		public void removeFromParent() {
        	StyledTextImpl.this.getParent().remove(StyledTextImpl.this);
		}
        @Override
		...
		public void setMyAttribute(String name, Object value) {
			...
			StyledTextImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(StyledTextImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(StyledTextImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(StyledTextImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(StyledTextImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(StyledTextImpl.this, 4, value);
    	}
        	public void state0() {
        		ViewImpl.state(StyledTextImpl.this, 0);
        	}
        	public void state1() {
        		ViewImpl.state(StyledTextImpl.this, 1);
        	}
        	public void state2() {
        		ViewImpl.state(StyledTextImpl.this, 2);
        	}
        	public void state3() {
        		ViewImpl.state(StyledTextImpl.this, 3);
        	}
        	public void state4() {
        		ViewImpl.state(StyledTextImpl.this, 4);
        	}
                        
        public void stateYes() {
        	ViewImpl.stateYes(StyledTextImpl.this);
	...
	public IWidget newInstance() {
		return new StyledTextImpl(groupName, localName);
	}
	...
	public void create(IFragment fragment, Map<String, Object> params) {
		...
		measurableView = new StyledTextExt();
		nativeCreate(params);	
...
public java.util.Map<String, Object> getOnafterTextChangeEventObj(Editable s) {
	...
	private void commitText(Object value) {
	    ...
	    styledText.setSelection(selection.x +  ((String) value).length());
	}
	...
	private void deletePreviousCharacter() {
		...
		if (selection.x != selection.y) {
			styledText.replaceTextRange(selection.x, selection.y - selection.x, "");
			styledText.setCaretOffset(selection.x);
			return;
		}

		// Delete previous character
		if (selection.x > 0) {
			styledText.replaceTextRange(selection.x - 1, 1, "");
			styledText.setCaretOffset(selection.x - 1);
		}
	}
