...
public class ImageRadioButtonImpl extends BaseWidget implements IDrawable, ICustomMeasureHeight, ICustomMeasureWidth, IHasMultiNativeWidgets, IsRadioButton{
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("ImageRadioButton.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("ImageRadioButton.tintMode").withOrder(-10));
	...
	public  ImageRadioButtonImpl(String localname) {
		super(GROUP_NAME, localname);
	}
	public  ImageRadioButtonImpl(String groupName, String localname) {
	...
	public class ImageRadioButtonExt extends r.android.widget.RadioButton implements ILifeCycleDecorator{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
	        ...
	        overlays = ViewImpl.drawOverlay(ImageRadioButtonImpl.this, overlays);
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(ImageRadioButtonImpl.this.getParent());
		...
		public void removeFromParent() {
        	ImageRadioButtonImpl.this.getParent().remove(ImageRadioButtonImpl.this);
		}
        @Override
		...
		public void setMyAttribute(String name, Object value) {
			...
			ImageRadioButtonImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(ImageRadioButtonImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(ImageRadioButtonImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(ImageRadioButtonImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(ImageRadioButtonImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(ImageRadioButtonImpl.this, 4, value);
    	}
        	public void state0() {
        		ViewImpl.state(ImageRadioButtonImpl.this, 0);
        	}
        	public void state1() {
        		ViewImpl.state(ImageRadioButtonImpl.this, 1);
        	}
        	public void state2() {
        		ViewImpl.state(ImageRadioButtonImpl.this, 2);
        	}
        	public void state3() {
        		ViewImpl.state(ImageRadioButtonImpl.this, 3);
        	}
        	public void state4() {
        		ViewImpl.state(ImageRadioButtonImpl.this, 4);
        	}
                        
        public void stateYes() {
        	ViewImpl.stateYes(ImageRadioButtonImpl.this);
	...
	public IWidget newInstance() {
		return new ImageRadioButtonImpl(groupName, localName);
	}
	...
	public void create(IFragment fragment, Map<String, Object> params) {
		...
		measurableView = new ImageRadioButtonExt();
		nativeCreate(params);	
...
public ImageRadioButtonCommandBuilder setDrawablePadding(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setDrawableTint(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setDrawableTintMode(String value) {
...
public ImageRadioButtonCommandBuilder setTextFormat(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setTextAppearance(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setDrawableIconSize(String value) {
