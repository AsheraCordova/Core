...
public class LinkImpl extends BaseWidget implements IDrawable, IHasMultiNativeWidgets, ICustomMeasureHeight, ICustomMeasureWidth{
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("com.ashera.layout.Link.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("com.ashera.layout.Link.tintMode").withOrder(-10));
	...
	public class LinkExt extends r.android.widget.TextView implements ILifeCycleDecorator{
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(LinkImpl.this.getParent());
		...
		public void removeFromParent() {
        	LinkImpl.this.getParent().remove(LinkImpl.this);
		}
        @Override
        ...
        public int computeSize(float width) {
        	return nativeMeasureHeight(link, (int) width);
    	}
		@Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(LinkImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(LinkImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(LinkImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(LinkImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(LinkImpl.this, 4, value);
    	}
        	public void state0() {
...
return getLastBaselineToBottomHeight();				}
    ...
    private FontData[] getFontData() {
    	FontData[] fontData = this.newFont == null ? link.getFont().getFontData() : this.newFont.getFontData();
    	return fontData;
    }
...
//		timer = null;
	...
	private int getLinkTextAlignment() {
		...
		if (measurableView.getHorizonantalAligment() != null) {
			switch (measurableView.getHorizonantalAligment()) {
			case center:
	...
	private void setLinkHorizontalAligmentCenter() {
		measurableView.setHorizonantalAligment(com.ashera.view.BaseMeasurableView.HorizonantalAligment.center);
	}

	private void setLinkHorizontalAligmentRight() {
		measurableView.setHorizonantalAligment(com.ashera.view.BaseMeasurableView.HorizonantalAligment.right);
	}

	private void setLinkHorizontalAligmentLeft() {
		measurableView.setHorizonantalAligment(com.ashera.view.BaseMeasurableView.HorizonantalAligment.left);
	}
