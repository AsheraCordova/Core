...
public class TextViewButtonImpl extends BaseWidget  implements IDrawable, IHasMultiNativeWidgets, ICustomMeasureHeight, ICustomMeasureWidth{
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("TextViewButton.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("TextViewButton.tintMode").withOrder(-10));
	...
	public  TextViewButtonImpl(String localname) {
		super(GROUP_NAME, localname);
	}
	public  TextViewButtonImpl(String groupName, String localname) {
	...
	public class TextViewButtonExt extends r.android.widget.TextView implements ILifeCycleDecorator{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
	        ...
	        overlays = ViewImpl.drawOverlay(TextViewButtonImpl.this, overlays);
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(TextViewButtonImpl.this.getParent());
		...
		public void removeFromParent() {
        	TextViewButtonImpl.this.getParent().remove(TextViewButtonImpl.this);
		}
        @Override
		...
		public void setMyAttribute(String name, Object value) {
			...
			TextViewButtonImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(TextViewButtonImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(TextViewButtonImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(TextViewButtonImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(TextViewButtonImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(TextViewButtonImpl.this, 4, value);
    	}
        	public void state0() {
	...
	public IWidget newInstance() {
		return new TextViewButtonImpl(groupName, localName);
	}
	...
	public void create(IFragment fragment, Map<String, Object> params) {
		...
		measurableView = new TextViewButtonExt();
		nativeCreate(params);	
...
public TextViewButtonCommandBuilder setDrawablePadding(String value) {
	...
	attrs.put("value", value);
return this;}
public TextViewButtonCommandBuilder setDrawableTint(String value) {
	...
	attrs.put("value", value);
return this;}
public TextViewButtonCommandBuilder setDrawableTintMode(String value) {
...
public TextViewButtonCommandBuilder setTextFormat(String value) {
	...
	attrs.put("value", value);
return this;}
public TextViewButtonCommandBuilder setTextAppearance(String value) {
	...
	attrs.put("value", value);
return this;}
public TextViewButtonCommandBuilder setDrawableIconSize(String value) {
