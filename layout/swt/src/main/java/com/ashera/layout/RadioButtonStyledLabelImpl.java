...
public class RadioButtonStyledLabelImpl extends BaseWidget implements IDrawable, ICustomMeasureHeight, ICustomMeasureWidth, IHasMultiNativeWidgets, IsRadioButton, com.ashera.validations.FormElement {
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("RadioButtonStyledLabel.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("RadioButtonStyledLabel.tintMode").withOrder(-10));
	...
	public  RadioButtonStyledLabelImpl(String localname) {
		super(GROUP_NAME, localname);
	}
	public  RadioButtonStyledLabelImpl(String groupName, String localname) {
	...
	public class RadioButtonStyledLabelExt extends r.android.widget.RadioButton implements ILifeCycleDecorator{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
	        ...
	        overlays = ViewImpl.drawOverlay(RadioButtonStyledLabelImpl.this, overlays);
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(RadioButtonStyledLabelImpl.this.getParent());
		...
		public void removeFromParent() {
        	RadioButtonStyledLabelImpl.this.getParent().remove(RadioButtonStyledLabelImpl.this);
		}
        @Override
		...
		public void setMyAttribute(String name, Object value) {
			...
			RadioButtonStyledLabelImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(RadioButtonStyledLabelImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(RadioButtonStyledLabelImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(RadioButtonStyledLabelImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(RadioButtonStyledLabelImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(RadioButtonStyledLabelImpl.this, 4, value);
    	}
        	public void state0() {
        		ViewImpl.state(RadioButtonStyledLabelImpl.this, 0);
        	}
        	public void state1() {
        		ViewImpl.state(RadioButtonStyledLabelImpl.this, 1);
        	}
        	public void state2() {
        		ViewImpl.state(RadioButtonStyledLabelImpl.this, 2);
        	}
        	public void state3() {
        		ViewImpl.state(RadioButtonStyledLabelImpl.this, 3);
        	}
        	public void state4() {
        		ViewImpl.state(RadioButtonStyledLabelImpl.this, 4);
        	}
                        
        public void stateYes() {
        	ViewImpl.stateYes(RadioButtonStyledLabelImpl.this);
	...
	public IWidget newInstance() {
		return new RadioButtonStyledLabelImpl(groupName, localName);
	}
	...
	public void create(IFragment fragment, Map<String, Object> params) {
		...
		measurableView = new RadioButtonStyledLabelExt();
		nativeCreate(params);	
...
return getLastBaselineToBottomHeight();				}
	...
	public int measureWidth() {
		...
		return styledText.computeSize(org.eclipse.swt.SWT.DEFAULT, org.eclipse.swt.SWT.DEFAULT).x + wrapperCompositeWidth + measurableView.getButtonDrawable().getMinimumWidth();
	}
	//end - dimenmeasure
...
public RadioButtonStyledLabelCommandBuilder setDrawablePadding(String value) {
	...
	attrs.put("value", value);
return this;}
public RadioButtonStyledLabelCommandBuilder setDrawableTint(String value) {
	...
	attrs.put("value", value);
return this;}
public RadioButtonStyledLabelCommandBuilder setDrawableTintMode(String value) {
...
public RadioButtonStyledLabelCommandBuilder setTextFormat(String value) {
	...
	attrs.put("value", value);
return this;}
public RadioButtonStyledLabelCommandBuilder setTextAppearance(String value) {
	...
	attrs.put("value", value);
return this;}
public RadioButtonStyledLabelCommandBuilder setDrawableIconSize(String value) {
