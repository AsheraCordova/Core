...
public class CheckBoxStyledLabelImpl extends BaseWidget implements IDrawable, ICustomMeasureHeight, ICustomMeasureWidth, IHasMultiNativeWidgets, com.ashera.validations.FormElement{
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("CheckBoxStyledLabel.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("CheckBoxStyledLabel.tintMode").withOrder(-10));
	...
	public  CheckBoxStyledLabelImpl(String localname) {
		super(GROUP_NAME, localname);
	}
	public  CheckBoxStyledLabelImpl(String groupName, String localname) {
	...
	public class CheckBoxStyledLabelExt extends r.android.widget.CheckBox implements ILifeCycleDecorator{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
	        ...
	        overlays = ViewImpl.drawOverlay(CheckBoxStyledLabelImpl.this, overlays);
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(CheckBoxStyledLabelImpl.this.getParent());
		...
		public void removeFromParent() {
        	CheckBoxStyledLabelImpl.this.getParent().remove(CheckBoxStyledLabelImpl.this);
		}
        @Override
		...
		public void setMyAttribute(String name, Object value) {
			...
			CheckBoxStyledLabelImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(CheckBoxStyledLabelImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(CheckBoxStyledLabelImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(CheckBoxStyledLabelImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(CheckBoxStyledLabelImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(CheckBoxStyledLabelImpl.this, 4, value);
    	}
        	public void state0() {
        		ViewImpl.state(CheckBoxStyledLabelImpl.this, 0);
        	}
        	public void state1() {
        		ViewImpl.state(CheckBoxStyledLabelImpl.this, 1);
        	}
        	public void state2() {
        		ViewImpl.state(CheckBoxStyledLabelImpl.this, 2);
        	}
        	public void state3() {
        		ViewImpl.state(CheckBoxStyledLabelImpl.this, 3);
        	}
        	public void state4() {
        		ViewImpl.state(CheckBoxStyledLabelImpl.this, 4);
        	}
                        
        public void stateYes() {
        	ViewImpl.stateYes(CheckBoxStyledLabelImpl.this);
	...
	public IWidget newInstance() {
		return new CheckBoxStyledLabelImpl(groupName, localName);
	}
	...
	public void create(IFragment fragment, Map<String, Object> params) {
		...
		measurableView = new CheckBoxStyledLabelExt();
		nativeCreate(params);	
...
public CheckBoxStyledLabelCommandBuilder setDrawablePadding(String value) {
	...
	attrs.put("value", value);
return this;}
public CheckBoxStyledLabelCommandBuilder setDrawableTint(String value) {
	...
	attrs.put("value", value);
return this;}
public CheckBoxStyledLabelCommandBuilder setDrawableTintMode(String value) {
...
public CheckBoxStyledLabelCommandBuilder setTextFormat(String value) {
	...
	attrs.put("value", value);
return this;}
public CheckBoxStyledLabelCommandBuilder setTextAppearance(String value) {
	...
	attrs.put("value", value);
return this;}
public CheckBoxStyledLabelCommandBuilder setDrawableIconSize(String value) {
