...
public class ImageCheckBoxImpl extends BaseWidget implements IDrawable, ICustomMeasureHeight, ICustomMeasureWidth, IHasMultiNativeWidgets{
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("ImageCheckBox.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("ImageCheckBox.tintMode").withOrder(-10));
	...
	public class ImageCheckBoxExt extends r.android.widget.CheckBox implements ILifeCycleDecorator{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
	        ...
	        overlays = ViewImpl.drawOverlay(ImageCheckBoxImpl.this, overlays);
		...
		public void setMyAttribute(String name, Object value) {
			...
			ImageCheckBoxImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(ImageCheckBoxImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(ImageCheckBoxImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(ImageCheckBoxImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(ImageCheckBoxImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(ImageCheckBoxImpl.this, 4, value);
    	}
        	public void state0() {
        		ViewImpl.state(ImageCheckBoxImpl.this, 0);
        	}
        	public void state1() {
        		ViewImpl.state(ImageCheckBoxImpl.this, 1);
        	}
        	public void state2() {
        		ViewImpl.state(ImageCheckBoxImpl.this, 2);
        	}
        	public void state3() {
        		ViewImpl.state(ImageCheckBoxImpl.this, 3);
        	}
        	public void state4() {
        		ViewImpl.state(ImageCheckBoxImpl.this, 4);
        	}
                        
        public void stateYes() {
        	ViewImpl.stateYes(ImageCheckBoxImpl.this);
...
public ImageCheckBoxCommandBuilder setDrawablePadding(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageCheckBoxCommandBuilder setDrawableTint(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageCheckBoxCommandBuilder setDrawableTintMode(String value) {
...
public ImageCheckBoxCommandBuilder setTextAppearance(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageCheckBoxCommandBuilder setDrawableIconSize(String value) {
