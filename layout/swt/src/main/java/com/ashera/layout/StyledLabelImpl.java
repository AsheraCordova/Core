...
public class StyledLabelImpl extends BaseWidget implements IDrawable, IHasMultiNativeWidgets, ICustomMeasureHeight, ICustomMeasureWidth, com.ashera.validations.ValidationErrorLabel {
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("StyledLabel.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("StyledLabel.tintMode").withOrder(-10));
	...
	public  StyledLabelImpl(String localname) {
		super(GROUP_NAME, localname);
	}
	public  StyledLabelImpl(String groupName, String localname) {
	...
	public class StyledLabelExt extends r.android.widget.TextView implements ILifeCycleDecorator{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
	        ...
	        overlays = ViewImpl.drawOverlay(StyledLabelImpl.this, overlays);
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(StyledLabelImpl.this.getParent());
		...
		public void removeFromParent() {
        	StyledLabelImpl.this.getParent().remove(StyledLabelImpl.this);
		}
        @Override
		...
		public void setMyAttribute(String name, Object value) {
			...
			StyledLabelImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
        ...
        public int computeSize(float width) {
        	return nativeMeasureHeight(styledText, (int) width);
    	}
		@Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(StyledLabelImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(StyledLabelImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(StyledLabelImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(StyledLabelImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(StyledLabelImpl.this, 4, value);
    	}
        	public void state0() {
	...
	public IWidget newInstance() {
		return new StyledLabelImpl(groupName, localName);
	}
	...
	public void create(IFragment fragment, Map<String, Object> params) {
		...
		measurableView = new StyledLabelExt();
		nativeCreate(params);	
...
public StyledLabelCommandBuilder setDrawablePadding(String value) {
	...
	attrs.put("value", value);
return this;}
public StyledLabelCommandBuilder setDrawableTint(String value) {
	...
	attrs.put("value", value);
return this;}
public StyledLabelCommandBuilder setDrawableTintMode(String value) {
...
public StyledLabelCommandBuilder setTextFormat(String value) {
	...
	attrs.put("value", value);
return this;}
public StyledLabelCommandBuilder setTextAppearance(String value) {
	...
	attrs.put("value", value);
return this;}
public StyledLabelCommandBuilder setDrawableIconSize(String value) {
...
public void setDrawableIconSize(String value) {
	...
	private Object getMyTextSize() {
		if (newFont !=  null) {
			return newFont.getFontData()[0].getHeight();
		}
