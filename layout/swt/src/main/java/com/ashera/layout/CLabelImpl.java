...
public class CLabelImpl extends BaseWidget implements IDrawable, IHasMultiNativeWidgets, ICustomMeasureHeight, ICustomMeasureWidth, com.ashera.validations.ValidationErrorLabel {
	...
	public  CLabelImpl(String localname) {
		super(GROUP_NAME, localname);
	}
	public  CLabelImpl(String groupName, String localname) {
	...
	public class CLabelExt extends r.android.widget.TextView implements ILifeCycleDecorator{
		...
		public void removeFromParent() {
        	CLabelImpl.this.getParent().remove(CLabelImpl.this);
		}
        @Override
        ...
        public int computeSize(float width) {
        	return nativeMeasureHeight(cLabel, (int) width);
    	}
		@Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(CLabelImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(CLabelImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(CLabelImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(CLabelImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(CLabelImpl.this, 4, value);
    	}
        	public void state0() {
	...
	public IWidget newInstance() {
		return new CLabelImpl(groupName, localName);
	}
...
public CLabelCommandBuilder setTextFormat(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setTextAppearance(String value) {
