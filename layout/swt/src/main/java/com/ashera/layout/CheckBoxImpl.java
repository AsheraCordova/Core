...
public class CheckBoxImpl extends BaseWidget implements IDrawable, ICustomMeasureHeight, ICustomMeasureWidth, IHasMultiNativeWidgets, com.ashera.validations.FormElement{
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("CheckBox.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("CheckBox.tintMode").withOrder(-10));
