...
public class TextViewImpl extends BaseWidget implements IDrawable, IHasMultiNativeWidgets, ICustomMeasureHeight, ICustomMeasureWidth, com.ashera.validations.ValidationErrorLabel{
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("TextView.tintMode", new TintMode());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("drawableTintMode").withType("TextView.tintMode").withOrder(-10));
