...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[194].selector = @selector(createLabelWithJavaUtilMap:withADTextView:);
  methods[195].selector = @selector(nativeSetUnderLineTextWithNSString:);
