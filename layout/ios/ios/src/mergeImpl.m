...
__attribute__((unused)) static void ASmergeImpl_nativeRemoveViewWithASIWidget_(ASmergeImpl *self, id<ASIWidget> widget);

__attribute__((unused)) static void ASmergeImpl_createLayoutParamsWithADView_(ASmergeImpl *self, ADView *view);

__attribute__((unused)) static ADFrameLayout_LayoutParams *ASmergeImpl_getLayoutParamsWithADView_(ASmergeImpl *self, ADView *view);

__attribute__((unused)) static void ASmergeImpl_nativeCreateWithJavaUtilMap_(ASmergeImpl *self, id<JavaUtilMap> params);
...
J2OBJC_FIELD_SETTER(ASmergeImpl_mergeExt, measureFinished_, ASMeasureEvent *)
...
J2OBJC_EMPTY_STATIC_INIT(ASmergeImpl_$Lambda$1)

__attribute__((unused)) static void ASmergeImpl_$Lambda$1_initWithASIWidget_(ASmergeImpl_$Lambda$1 *self, id<ASIWidget> capture$0);
...
- (instancetype)init {
  ASmergeImpl_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (instancetype)initWithNSString:(NSString *)localname {
  ASmergeImpl_initWithNSString_(self, localname);
  return self;
}

- (instancetype)initWithNSString:(NSString *)groupName
                    withNSString:(NSString *)localname {
  ASmergeImpl_initWithNSString_withNSString_(self, groupName, localname);
  return self;
}

- (id<ASIWidget>)newInstance {
  return new_ASmergeImpl_initWithNSString_withNSString_(groupName_, localName_);
}

- (void)createWithASIFragment:(id<ASIFragment>)fragment
              withJavaUtilMap:(id<JavaUtilMap>)params {
  [super createWithASIFragment:fragment withJavaUtilMap:params];
  frameLayout_ = new_ASmergeImpl_mergeExt_initWithASmergeImpl_(self);
  ASmergeImpl_nativeCreateWithJavaUtilMap_(self, params);
  ASViewGroupImpl_registerCommandConveterWithASIWidget_(self);
  ASmergeImpl_setWidgetOnNativeClass(self);
}
...
- (ADFrameLayout_LayoutParams *)getLayoutParamsWithADView:(ADView *)view {
  return ASmergeImpl_getLayoutParamsWithADView_(self, view);
}
...
- (void)setChildAttributeWithASIWidget:(id<ASIWidget>)w
                 withASWidgetAttribute:(ASWidgetAttribute *)key
                          withNSString:(NSString *)strValue
                                withId:(id)objValue {
  ADView *view = (ADView *) cast_chk([((id<ASIWidget>) nil_chk(w)) asWidget], [ADView class]);
  ADFrameLayout_LayoutParams *layoutParams = ASmergeImpl_getLayoutParamsWithADView_(self, view);
...
- (IOSClass *)getViewClass {
  return ASmergeImpl_mergeExt_class_();
}
...
void ASmergeImpl_init(ASmergeImpl *self) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, ASmergeImpl_GROUP_NAME, ASmergeImpl_LOCAL_NAME);
}

ASmergeImpl *new_ASmergeImpl_init() {
  J2OBJC_NEW_IMPL(ASmergeImpl, init)
}

ASmergeImpl *create_ASmergeImpl_init() {
  J2OBJC_CREATE_IMPL(ASmergeImpl, init)
}

void ASmergeImpl_initWithNSString_(ASmergeImpl *self, NSString *localname) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, ASmergeImpl_GROUP_NAME, localname);
}

ASmergeImpl *new_ASmergeImpl_initWithNSString_(NSString *localname) {
  J2OBJC_NEW_IMPL(ASmergeImpl, initWithNSString_, localname)
}

ASmergeImpl *create_ASmergeImpl_initWithNSString_(NSString *localname) {
  J2OBJC_CREATE_IMPL(ASmergeImpl, initWithNSString_, localname)
}

void ASmergeImpl_initWithNSString_withNSString_(ASmergeImpl *self, NSString *groupName, NSString *localname) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, groupName, localname);
}

ASmergeImpl *new_ASmergeImpl_initWithNSString_withNSString_(NSString *groupName, NSString *localname) {
  J2OBJC_NEW_IMPL(ASmergeImpl, initWithNSString_withNSString_, groupName, localname)
}

ASmergeImpl *create_ASmergeImpl_initWithNSString_withNSString_(NSString *groupName, NSString *localname) {
  J2OBJC_CREATE_IMPL(ASmergeImpl, initWithNSString_withNSString_, groupName, localname)
}

void ASmergeImpl_setWidgetOnNativeClass(ASmergeImpl *self) {
  ((ASUIView*) [self asNativeWidget]).widget = self;
}

void ASmergeImpl_nativeRemoveViewWithASIWidget_(ASmergeImpl *self, id<ASIWidget> widget) {
  ...
  if (layoutTransition != nil && ([layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_CHANGE_DISAPPEARING] || [layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_DISAPPEARING])) {
    [self addToBufferedRunnablesWithJavaLangRunnable:new_ASmergeImpl_$Lambda$1_initWithASIWidget_(widget)];
  }
  else {
...
void ASmergeImpl_createLayoutParamsWithADView_(ASmergeImpl *self, ADView *view) {
...
ADFrameLayout_LayoutParams *ASmergeImpl_getLayoutParamsWithADView_(ASmergeImpl *self, ADView *view) {
  return (ADFrameLayout_LayoutParams *) cast_chk([((ADView *) nil_chk(view)) getLayoutParams], [ADFrameLayout_LayoutParams class]);
}

void ASmergeImpl_nativeCreateWithJavaUtilMap_(ASmergeImpl *self, id<JavaUtilMap> params) {
}
...
- (instancetype)initWithASmergeImpl:(ASmergeImpl *)outer$ {
  ASmergeImpl_mergeExt_initWithASmergeImpl_(self, outer$);
  return self;
}
...
- (void)__javaClone:(ASmergeImpl_mergeExt *)original {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(initWithASmergeImpl:);
...
ASmergeImpl_mergeExt *new_ASmergeImpl_mergeExt_initWithASmergeImpl_(ASmergeImpl *outer$) {
  J2OBJC_NEW_IMPL(ASmergeImpl_mergeExt, initWithASmergeImpl_, outer$)
}

ASmergeImpl_mergeExt *create_ASmergeImpl_mergeExt_initWithASmergeImpl_(ASmergeImpl *outer$) {
  J2OBJC_CREATE_IMPL(ASmergeImpl_mergeExt, initWithASmergeImpl_, outer$)
}
...
void ASmergeImpl_$Lambda$1_initWithASIWidget_(ASmergeImpl_$Lambda$1 *self, id<ASIWidget> capture$0) {
  self->val$widget_ = capture$0;
  NSObject_init(self);
}

ASmergeImpl_$Lambda$1 *new_ASmergeImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_NEW_IMPL(ASmergeImpl_$Lambda$1, initWithASIWidget_, capture$0)
}

ASmergeImpl_$Lambda$1 *create_ASmergeImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_CREATE_IMPL(ASmergeImpl_$Lambda$1, initWithASIWidget_, capture$0)
}
